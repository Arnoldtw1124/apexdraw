 ...
 * Cleaned: Removed all parenthetical English names.
 */

const APEX_DATA = {
  classes: {
    assault: { name: '突擊', color: '#FF4A4A' },
    skirmisher: { name: '游擊', color: '#4AF2FF' },
    recon: { name: '偵察', color: '#FFD44A' },
    support: { name: '支援', color: '#4AFF85' },
    controller: { name: '控場', color: '#B84AFF' }
  },
  ...
  weaponCategories: {
    ar: { name: '突擊步槍', color: '#FF5722' },
    smg: { name: '衝鋒槍', color: '#00BCD4' },
    lmg: { name: '輕機槍', color: '#8BC34A' },
    marksman: { name: '神射手步槍', color: '#FFC107' },
    sniper: { name: '狙擊槍', color: '#9C27B0' },
    shotgun: { name: '霰彈槍', color: '#F44336' },
    pistol: { name: '手槍', color: '#FF9800' }
  },
